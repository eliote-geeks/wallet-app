...
psql -U "$POSTGRES_USER" -d "${POSTGRES_APP_DB}" -c "GRANT ALL ON SCHEMA public TO ${POSTGRES_APP_USER};"
psql -U "$POSTGRES_USER" -d "${POSTGRES_APP_DB}" -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO ${POSTGRES_APP_USER};"
psql -U "$POSTGRES_USER" -d "${POSTGRES_APP_DB}" -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO ${POSTGRES_APP_USER};"

psql -U "$POSTGRES_USER" -d "${POSTGRES_KEYCLOAK_DB}" -c "ALTER SCHEMA public OWNER TO ${POSTGRES_KEYCLOAK_USER};"
psql -U "$POSTGRES_USER" -d "${POSTGRES_KEYCLOAK_DB}" -c "GRANT ALL ON SCHEMA public TO ${POSTGRES_KEYCLOAK_USER};"
psql -U "$POSTGRES_USER" -d "${POSTGRES_KEYCLOAK_DB}" -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO ${POSTGRES_KEYCLOAK_USER};"
psql -U "$POSTGRES_USER" -d "${POSTGRES_KEYCLOAK_DB}" -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO ${POSTGRES_KEYCLOAK_USER};"
